 ...
 */
@Entity
@Table(name = "t_raw_xin_fund_asset", uniqueConstraints = { @UniqueConstraint(columnNames = { "bh", "ywrq" }) })
public class ResponseDetail implements Serializable {
	...
	@SequenceGenerator(name = "sequence", sequenceName = "seq_t_raw_xin_fund_asset") // 适配oracle等没有主键自增长的数据库，改用sequence
	...
	public String toString() {
		return "ResponseDetail [sl=" + sl + ", cb=" + cb + ", szzjz=" + szzjz + ", ztbh=" + ztbh + ", sfqr=" + sfqr
				+ ", kmmc=" + kmmc + ", hqjz=" + hqjz + ", bh=" + bh + ", ywrq=" + ywrq + ", cbzjz=" + cbzjz + ", kmdm="
				+ kmdm + ", gzzz=" + gzzz + ", sz=" + sz + ", dwcb=" + dwcb + ", fullname=" + fullname + ", getSl()="
				+ getSl() + ", getCb()=" + getCb() + ", getSzzjz()=" + getSzzjz() + ", getZtbh()=" + getZtbh()
				+ ", getSfqr()=" + getSfqr() + ", getKmmc()=" + getKmmc() + ", getHqjz()=" + getHqjz() + ", getBh()="
				+ getBh() + ", getYwrq()=" + getYwrq() + ", getCbzjz()=" + getCbzjz() + ", getKmdm()=" + getKmdm()
				+ ", getGzzz()=" + getGzzz() + ", getSz()=" + getSz() + ", getDwcb()=" + getDwcb() + ", getFullname()="
