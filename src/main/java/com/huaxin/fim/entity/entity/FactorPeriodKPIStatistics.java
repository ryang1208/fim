 ...
 */
@Entity
@Table(name = "t_factor_period_kpi_statistics" , uniqueConstraints = {@UniqueConstraint(columnNames = {"date","KPI", "factor_id"})})

public class FactorPeriodKPIStatistics implements Serializable {
