 ...
 */
@Entity
@Table(name = "t_factor_industry_period_statistics" , uniqueConstraints = {@UniqueConstraint(columnNames = {"date","industry","kpi","factor_id"})})
public class FactorIndustryPeriodStatistics implements Serializable {
