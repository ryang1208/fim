 ...
 */
@Entity
@Table(name = "t_factor_statistics", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "date", "factor_id", "factor_type"})})
public class FactorStatistics implements Serializable {
