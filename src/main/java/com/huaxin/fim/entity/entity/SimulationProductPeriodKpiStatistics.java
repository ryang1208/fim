...
@Embeddable
@Entity
@Table(name = "t_simulation_product_period_kpi_statistics", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "date", "product_id", "KPI" }) })

public class SimulationProductPeriodKpiStatistics implements Serializable {
