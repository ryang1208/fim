 ...
 */
@Entity
@Table(name = "t_raw_qdiam_invester_fund", uniqueConstraints = { @UniqueConstraint(columnNames = { "date", "invester_id","broker_id" }) })
public class RawQDIAMInvesterFund implements Serializable {
