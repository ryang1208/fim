 ...
 */
@Entity
@Table(name = "t_raw_hs_transaction_details")
public class HSCTPTransactionDetails implements Serializable {
	...
	//权利金收支
	@Column(name = "premium_put_paid", precision = 20, scale = 4)
	@Digits(integer = 16, fraction = 4)
	private BigDecimal premiumPutPaid;
	...
	public BigDecimal getPremiumPutPaid() {
		return premiumPutPaid;
	}

	public void setPremiumPutPaid(BigDecimal premiumPutPaid) {
		this.premiumPutPaid = premiumPutPaid;
	}
