...
@Embeddable
@Entity
@Table(name = "t_product_period_his_statistics")

public class ProductPeriodHisStatistics implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4220526398821283106L;
