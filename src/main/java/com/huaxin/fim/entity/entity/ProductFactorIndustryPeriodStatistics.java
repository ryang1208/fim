 ...
 */
@Entity
@Table(name = "t_product_factor_industry_period_statistics" , uniqueConstraints = {@UniqueConstraint(columnNames = {"date","industry","product_id","kpi","factor_id"})})
public class ProductFactorIndustryPeriodStatistics implements Serializable {
	...
	// 因子代码
	@Id
	@Column(name = "factor_id", length = 6)
	@NotNull
	@NotBlank
