...
@Embeddable
@Entity
@Table(name = "t_invest_daily_kpi_statistics" , uniqueConstraints = {@UniqueConstraint(columnNames = {"date","broker_invester_id","KPI"})})

public class InvestPeriodKPIStatistics implements Serializable {
