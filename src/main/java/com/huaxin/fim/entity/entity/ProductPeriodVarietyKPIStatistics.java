...
@Embeddable
@Entity
@Table(name = "t_product_period_variety_kpi_statistics" , uniqueConstraints = {@UniqueConstraint(columnNames = {"date","product_id","KPI","variety"})})

public class ProductPeriodVarietyKPIStatistics implements Serializable {
