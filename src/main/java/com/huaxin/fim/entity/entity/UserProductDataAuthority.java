 ...
 */
@Entity
@Table(name = "t_user_product_data_authority", uniqueConstraints = {@UniqueConstraint(columnNames = {"user_id", "category", "item_id"})})
public class UserProductDataAuthority implements Serializable {
