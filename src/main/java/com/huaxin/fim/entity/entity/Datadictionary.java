...
@Embeddable
@Entity
@Table(name = "t_iwin_data_dictionary" , uniqueConstraints = {@UniqueConstraint(columnNames = {"data_type","data_code"})})
public class Datadictionary implements Serializable {
	...
	public Datadictionary(Long id,String dataType, String dataTypeDescribe) {
		this.id = id;
		this.dataType = dataType;
		this.dataTypeDescribe = dataTypeDescribe;
	}
